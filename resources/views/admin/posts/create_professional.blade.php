                        ...
                        <div id="english-fields" style="display: none;">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror" 
                                       id="title" name="title" value="{{ old('title') }}" placeholder="Enter post title in English">
                                @error('title')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div id="vietnamese-fields" style="display: none;">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('title_vi') is-invalid @enderror" 
                                       id="title_vi" name="title_vi" value="{{ old('title_vi') }}" placeholder="Nhập tiêu đề bài viết">
                                @error('title_vi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description_vi') is-invalid @enderror" 
                                          ...
                                          placeholder="Tóm tắt ngắn gọn về bài viết (tùy chọn)">{{ old('description_vi') }}</textarea>
                        ...
                        <div id="vietnamese-content" style="display: none;">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('content_vi') is-invalid @enderror" 
                                          id="content_vi" name="content_vi" rows="15">{{ old('content_vi') }}</textarea>
                                @error('content_vi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="alert alert-info">
                            <h6><i class="bi bi-lightbulb"></i> Tips for creating great posts:</h6>
                            <ul class="mb-0">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Trigger language change if there's an old value
    const oldLanguage = '{{ old("language") }}';
    if (oldLanguage) {
